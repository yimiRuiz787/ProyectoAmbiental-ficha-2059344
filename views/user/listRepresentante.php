<div class="main-content">
	<div class="section__content section__content--p30">
		<div class="container-fluid">						
			<div class="col-md-12">
				<!-- DATA TABLE -->
				<h3 class="title-1 m-b-35">Listado de Representantes</h3>
				<div class="table-data__tool">
					<div class="table-data__tool-left">
						<div class="rs-select2--light rs-select2--md">
							<h3 class="title-5 m-b-35">Representantes</h3>
						</div>
					...
					<div class="navegador">
							...
							<a id="hola" class="coloractivado" href="#"><i class="fas fa-briefcase"></i> Representante</a> 
